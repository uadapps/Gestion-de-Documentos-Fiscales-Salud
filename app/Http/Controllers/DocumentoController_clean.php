    ...
    private function campusTieneCarrerasMedicas($campusId)
    {
        try {
            $carrerasMedicas = DB::select("
                ...
                WHERE (e.descripcion LIKE '%MEDIC%' OR E.Descripcion LIKE '%ENFER%' OR E.Descripcion LIKE '%NUTRI%' OR E.Descripcion LIKE '%FISIO%' OR E.Descripcion LIKE '%ODONTO%' OR E.Descripcion LIKE '%COSME%')
